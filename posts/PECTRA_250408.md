...
Those optimizations shall lead to a reduction around 40\% (asymptotically) of the  ECC proving cost (being around 3.5 seconds on a phone, it would fell below 2). Find some benchmarks by Distributed Labs [here](https://github.com/distributed-lab/papers/blob/main/circom/bls12_381_vs_bn254.pdf).
