...
Bunding is just a matter of defining how an array of those elements can be transferred as parameters of the batching function, then issue a transaction that'll perform the bundled calls. 
