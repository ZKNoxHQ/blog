...
Those optimizations shall lead to a reduction around 40\% (asymptotically) of the  ECC proving cost (required times). Find some benchmarks by Distributed Labs [here](https://github.com/distributed-lab/papers/blob/main/circom/bls12_381_vs_bn254.pdf).
